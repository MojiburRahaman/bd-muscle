                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 pl-5">
                                ...
                                <a href="{{route('ProductImagesDelete',$gallery->id)}}" style="padding:4px;font-size: larger;text-decoration:none;color:red;margin-left:7px"
                        ...
                        <div class="input-group mb-3">
                          ...
                          @error('flavour_name[]') is-invalid @enderror" value="{{$flavour->flavour_name}}"
                            ...
                            <div class="input-group-append">
                                <a href="{{route('ProductFlavourDelete',    $flavour->id)}}" id="removeRow" type="button" class="btn btn-danger">Remove</a>
                            </div>
                        </div>
                        @empty
                        <label for="">Flavour Name</label>
